...
define KernelPackage/bridge-netfilter
  SUBMENU:=$(NF_MENU)
  TITLE:=Bridge netfilter support
  DEPENDS:=+kmod-ipt-core +kmod-bridge
  KCONFIG:=CONFIG_BRIDGE_NETFILTER=y
endef

$(eval $(call KernelPackage,bridge-netfilter))

define KernelPackage/nf-conntrack-event
  SUBMENU:=$(NF_MENU)
  TITLE:=Netfilter connection tracking event support
  DEPENDS:=+kmod-nf-conntrack
  KCONFIG:=CONFIG_NF_CONNTRACK_EVENTS=y
endef

$(eval $(call KernelPackage,nf-conntrack-event))
